...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _handleRealtimeMessage(Map<String, dynamic> record) {
    ...
    final nextMessages = [..._messages, incoming]..sort(compareChatMessages);
    if (!mounted) return;
  ...
  void _scrollToBottom() {
    _scrollTimer?.cancel();
    _scrollTimer = Timer(const Duration(milliseconds: 40), () {
      if (!mounted) return;
        ...
        _scrollController
            ...
            .whenComplete(() {
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                ...
                if ((settledTarget - _scrollController.position.pixels).abs() >
                    2) {
